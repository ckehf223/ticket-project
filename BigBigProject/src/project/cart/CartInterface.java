...
public interface CartInterface {
	...
	boolean isCartInPerformance(String id,int num,String seat); // 장바구니에 담긴 갯수를 고객 임의 지정 좌석갯수 증가

	void insertPerformance(Performance p,int num,String seat); // CartItem에 공연 정보를 등록

	void removeCart(int numId); // 장바구니 순번 numId의 항목을 삭제

	void deletePerformance(ArrayList<Performance> list); // 장바구니의 모든 항목을 삭제
